...
{
	UIAlertView* popup = [[UIAlertView alloc] initWithTitle:@"New Git Repository" message:@"Git URL" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Add", nil];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        NSString* url = [object valueForKey:@"gitURL"];
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"gitURL" ascending:NO];
...
{
    NSManagedObject *object = [self.fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text = [[object valueForKey:@"gitURL"] description];
}
...
- (void)alertView:(UIAlertView*)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    [newManagedObject setValue:input.text forKey:@"gitURL"];
